import {
  ...
  getWithPathVariableAndRequestParameters,
} from "../lib/axios";
import {
  DataResponse,
  Error,
...
const genericRequestHandler = async <T>(
  ...
  return axiosResponse
    .then((response) => {
      ...
      return Promise.resolve(
        new SuccessfulDataResponse(dataResponse.message, dataResponse.data)
      );
    })
...
): Promise<DataResponse<Array<T>>> => {
  return genericRequestHandler<Array<T>>(
    getWithRequestParameter(url, requestParameters)
  );
};
...
const getAllWithPathVariable = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    getWithPathVariable(url, pathVariables)
  );
};
...
const getSingleWithRequestParameter = async <T extends Object>(
  ...
  return genericRequestHandler<T>(
    getWithRequestParameter(url, requestParameters)
  );
};
...
const getSingleWithPathVariableAndRequestParam = async <T extends Object>(
  url: string,
  pathVariables: { [key: string]: any } = {},
  requestParameters: { [key: string]: any } = {}
): Promise<DataResponse<T>> => {
...
const postAllWithRequestParameter = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    postWithRequestParameter(url, requestParameters, requestBody, config)
  );
};
...
const postAllWithPathVariable = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    postWithPathVariable(url, pathVariables, requestBody, config)
  );
};
...
const putAllWithRequestParameter = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    putWithRequestParameter(url, requestParameters, requestBody, config)
  );
};
...
const putAllWithPathVariable = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    putWithPathVariable(url, pathVariables, requestBody, config)
  );
};
...
const deleteAllWithRequestParameter = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    deleteWithRequestParameter(url, requestParameters, config)
  );
};
...
const deleteAllWithPathVariable = async <T extends Object>(
  ...
  return genericRequestHandler<Array<T>>(
    deleteWithPathVariable(url, pathVariables, config)
  );
};
...
export const GET_REQUEST = {
  ...
  SINGLE_WITH_PATH_VARIABLE_AND_REQUEST_PARAMETERS:
    getSingleWithPathVariableAndRequestParam,
};
